use temp;
GO
CREATE PROCEDURE AcademiaCompleto34
 AS
...
(--Listo
	...
	ID_Beca				int				not null,
	--Llave primaria esta mal que sea cedula porque si se digita mal se tendria que borrar 
...
(--correo
--Tipo persona tabla y que ese sea llave foranea a la tabla persona
...
create table Curso 
(--ID ARTE ES MEJOR UNIRLO PARA EVITAR EL CIRCULO
--TENER UNA LLAVE INTERMEDIA DE CURSO Y AULA
